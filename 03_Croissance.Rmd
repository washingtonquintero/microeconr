...
```{r mafig, fig.cap = "Vector algebra", echo = FALSE}
...
```{r smplregmodel, fig.cap = "Geometry of the simple regression model", echo = FALSE}
...
```{r multregmodel, fig.cap = "Geometry of the multiple regression model", echo = FALSE}
...
```{r frishwaugh, fig.cap = "The Frish-Waugh theorem", echo = FALSE}
